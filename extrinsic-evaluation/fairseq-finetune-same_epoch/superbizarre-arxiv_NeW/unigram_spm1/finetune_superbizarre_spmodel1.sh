...
DATA_DIR=../../data-bins/superbizarre/unigram/alpha0/vocab_size16000/spm1/arxiv-bin/
...
fairseq-train $DATA_DIR \
    ...
    --save-dir ../../models/wikipedia/unigram/alpha0/vocab_size16000/spm1/finetune-superbizarre-arxiv/seed_$seed/checkpoints_fixed_epoch 
