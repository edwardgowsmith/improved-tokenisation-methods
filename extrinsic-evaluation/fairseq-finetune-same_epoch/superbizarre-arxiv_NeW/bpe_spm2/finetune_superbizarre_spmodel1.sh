...
DATA_DIR=../../data-bins/superbizarre/bpe/alpha0/vocab_size16000/spm1/arxiv-bin/
...
fairseq-train $DATA_DIR \
    ...
    --save-dir ../../models/wikipedia/bpe/alpha0/vocab_size16000/spm2/finetune-superbizarre-arxiv_NEW/seed_$seed/checkpoints_fixed_epoch 
