...
DATA_DIR=../../data-bins/glue/unigram/alpha0/vocab_size16000/spm1/STS-B-bin/
...
fairseq-train $DATA_DIR \
    ...
    --max-epoch 20 \
    --save-dir ../../models/wikipedia/unigram/alpha0/vocab_size16000/spm1/finetune-sts/seed_$seed/checkpoints_fixed_epoch/ 
