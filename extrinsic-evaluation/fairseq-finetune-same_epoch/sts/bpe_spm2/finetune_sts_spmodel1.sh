...
DATA_DIR=../../data-bins/glue/bpe/alpha0/vocab_size16000/spm2/STS-B-bin/
...
fairseq-train $DATA_DIR \
    ...
    --max-epoch 20 \
    --save-dir ../../models/wikipedia/bpe/alpha0/vocab_size16000/spm2/finetune-sts/seed_$seed/checkpoints_fixed_epoch/ 
